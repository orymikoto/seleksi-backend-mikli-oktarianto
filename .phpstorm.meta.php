...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\1_orymikoto\seleksi-backend-mikli-oktarianto\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\1_orymikoto\\seleksi-backend-mikli-oktarianto\\public\\storage',
...
'sanctum.csrf-cookie','users.index','users.show',
'users.update','users.destroy',
'lokasi.index','lokasi.store','lokasi.show','lokasi.update','lokasi.destroy',
'mutasi.index','mutasi.store','mutasi.show','mutasi.update','mutasi.destroy',
'storage.local',);
